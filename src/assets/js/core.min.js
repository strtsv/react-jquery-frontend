...
// parallax
function scrollRate(t) {
  t.offset = "number" == typeof t.offset ? t.offset : 0.5;
  var e = function() {
    (this.scrollRate.rect = this.getBoundingClientRect()),
      (this.scrollRate.progress = function() {
        return this.scrollRate.rect.top > window.innerHeight * t.offset
          ? 0
          : this.scrollRate.rect.top <= window.innerHeight * t.offset &&
            this.scrollRate.rect.bottom >= window.innerHeight * t.offset
          ? Math.abs(this.scrollRate.rect.top - window.innerHeight * t.offset)
          : this.scrollRate.rect.height;
      }.call(this)),
      (this.scrollRate.distance =
        window.innerHeight * t.offset -
        (this.scrollRate.rect.top + this.scrollRate.rect.height / 2)),
      (this.scrollRate.progressRate =
        this.scrollRate.progress / this.scrollRate.rect.height),
      (this.scrollRate.distanceRate =
        this.scrollRate.distance / window.innerHeight),
